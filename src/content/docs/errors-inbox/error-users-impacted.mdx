...
First, we'll check for `enduser.id` according to the [OpenTelemetry standard](https://opentelemetry.io/docs/specs/semconv/attributes-registry/enduser/). Then we'll use the following attributes in order of priority:
